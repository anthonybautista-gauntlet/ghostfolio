import type { AiCitedFigure } from '@ghostfolio/common/interfaces';

import { Injectable } from '@nestjs/common';

import type { VerificationContract } from '../contracts/verification-contract.interface';

@Injectable()
export class GhostAgentVerificationService implements VerificationContract {
