...
export class ConfigurationService {
  ...
  public constructor() {
    this.environmentConfiguration = cleanEnv(process.env, {
      ...
      ENABLE_FEATURE_AGENTFORGE: bool({ default: true }),
      ...
      LANGSMITH_ENDPOINT: str({ default: 'https://api.smith.langchain.com' }),
      LANGSMITH_PROJECT: str({ default: 'ghostfolio-ghost-agent' }),
      LANGSMITH_TRACING: bool({ default: false }),
      LANGSMITH_WORKSPACE_ID: str({ default: '' }),
      ...
      AI_REQUEST_TIMEOUT: num({ default: ms('30 seconds') }),
      AI_DAILY_MESSAGE_LIMIT: num({ default: 100 }),
      AI_SIGNUP_RATE_LIMIT_MAX: num({ default: 5 }),
      AI_SIGNUP_RATE_LIMIT_WINDOW_MS: num({ default: ms('1 hour') }),
